...
class RiskAgent(BaseAgent):
    ...
    def system_prompt(self, ctx: AgentContext) -> str:
        ...
        ep_gloss = " (业绩预亏, 业绩变脸)" if zh_gloss else ""
        reg_gloss = " (监管处罚, 立案调查)" if zh_gloss else ""
...
1. **Insider / Major Shareholder Activity** — sell-downs{sell_gloss}, pledges
2. **Earnings Warnings** — pre-loss, downward revisions{ep_gloss}
3. **Regulatory** — penalties, investigations, violations{reg_gloss}
4. **Industry Policy** — headwinds, sector crackdowns
5. **Lock-up Expirations** — large block unlocks within 30 days{lock_gloss}
